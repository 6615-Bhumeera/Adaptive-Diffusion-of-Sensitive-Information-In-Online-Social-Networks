...
class adaptive_diffusion_model(models.Model):
    ...
    tweet_desc= models.CharField(max_length=30000)
    tweet_loc= models.CharField(max_length=300)
    tweet_date= models.CharField(max_length=300)
    score= models.IntegerField()
    retweet= models.CharField(max_length=30000)
    retweeter= models.CharField(max_length=300)
    retweet_date= models.CharField(max_length=300)
